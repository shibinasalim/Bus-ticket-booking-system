  ...
  if(isset($_POST['AddBus'])){
       ...
       if($conn->connect_error)
          ...
          else
          {
              ...
              $stmt=$conn->prepare("INSERT INTO bus(Bus_Number,Busname) VALUES(?,?)");
                ...
                <form action="#" method="POST">
                    <div class="form_wrap">
                        ...
                        <div class="input_wrap">
                            ...
                            <input type="text" id="title" name="bus_number" placeholder="Bus Number" required>
                        </div>


                        <div class="input_wrap">
                            <label for="title">BUS name</label>
                            <input type="text" id="title" name="Bus_name" placeholder="BusName" required>
                        </div>
