       ...
       if($conn->connect_error)
          ...
          else
          {
            ...
            //   $conn->close();
              ...
              $stmt=$conn->prepare("INSERT INTO ticket(username,ticket_no,route_id) VALUES(?,?,?)");
              $stmt->bind_param("sss",$username,$ticket,$route_id);
              $stmt->execute();
                ...
                <form action="#" method="POST">
                    <div class="form_wrap">
                        ...
                        <div class="input_wrap">
                            ...
                            <input type="text" id="title" name="passenger_name" value='<?php echo $user_data['username'] ?>' placeholder="Passenger Name" required>
                        </div>
                        ...
                        <div class="input_wrap">
                            ...
                            <input type="text" id="title" name="ticket_id" value='<?php echo $ticket ?>'  placeholder="Ticket Id" required>
                        </div>
                        ...
                        <div class="input_wrap">
                            ...
                            <input type="text" id="title" name="Your_destination" placeholder="Your destination"
                                required>
                        </div>
